...
<details>
<summary>What does it mean to 'pollute the global namespace' and how have we seen this problem in the browser?</summary>

> 'Polluting the global namespace' means declaring variables in global scope.
