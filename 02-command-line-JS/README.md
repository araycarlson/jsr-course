...
| --- | --- | --- | --- |
| `ls` | **L**i**s**t the contents of the directory | `code .` | Open VS code editor from this location|
...
5. Demonstrate how to open "index.html" in VS Code from the terminal. ```code```
...
1. Create a folder in your home `~` directory called Sites: `mkdir ~/Sites/`

2. Change into your Sites directory: `cd ~/Sites/`

3. Create a folder in your ~/Sites/ folder titled goals: `mkdir Goals/`

4. Once inside that folder, create three empty files:
  - goals.html
  - worries.html
  - index.html

5. Open VS Code Text, click File > Open Folder and navigate to your newly created ~/Sites/goals folder.
In the respective files (goals.html and worries.html), write your top three goals and top three worries for this course.

6. Paste the following contents into index.html:
...
7. Open index.html with your browser and make sure you see your goals and worries.
...
9. Try visiting https://username.github.io/goals (where "username" is your actual GitHub username)
  ...
  > last lesson), accidentally initializing a repository with a `README.md`
...
4. We can also print these variables to our console by typing ```console.log(x)```. We do not include quotes around variables like we do with 'Hello World'.
  ...
  > Note: Ask the class why this is the case and make sure they understand the difference between logging variables and strings as a precursor for the next lesson on data types. Students frequently get hung up on logging variables with quotes and strings without quotes.
