# ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Project 2: Feedr
...
For our Unit 2 project we will build **Feedr**, a personalized feed reader. Our
...
- A **new git repository hosted on Github**, where your codebase is maintained.
  - Most of the your will be done on the **app.js** file. You may update
...
You can then open VS Code and point it at the `~/Sites/feedr` directory and
